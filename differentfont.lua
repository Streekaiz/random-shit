...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        local HueTextSize = Library:GetTextBounds('Hex color', Enum.Font.SourceSansBold, 16) + 3
        local RgbTextSize = Library:GetTextBounds('255, 255, 255', Enum.Font.SourceSansBold, 16) + 3
