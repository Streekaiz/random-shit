...
function library:CreateWindow(name, size, hidebutton)
	...
	function window:CreateTab(name)
		...
		function tab:CreateConfigSystem(side)
			...
			configSystem.Create = configSystem.sector:AddButton("create config", function()
				for i,v in pairs(listfiles(configSystem.configFolder)) do
			...
			configSystem.Save = configSystem.sector:AddButton("save config", function()
				local config = {}
			...
			configSystem.Load = configSystem.sector:AddButton("load config", function()
			...
			configSystem.Delete = configSystem.sector:AddButton("delete config", function()
				for i,v in pairs(listfiles(configSystem.configFolder)) do
					Config:Remove(tostring(v):gsub(configSystem.configFolder .. "\\", ""):gsub(".txt", ""))
				end
